...
(* Rajout de fonctions pour les flottants *)
(* Opérations pour les flottants *)
...
let cvttsd2si a b = ins "cvttsd2si %a, %a" a () b () (* Conversion flottant -> entier *)
let cvtsi2sd a b = ins "cvtsi2sd %a, %a" a () b () (* Conversion entier -> flottant *)
(* Registres pour les flottants *)
let xmm0 = "%xmm0"
let xmm1 = "%xmm1"
let rspMinus8 = "-8(%rsp)"
let rspBis = "(%rsp)"
